...
module.exports = (router) => {
  ...
  router.get('/api/getMovies/:page', (req, res) => {
    fetch(`https://api.themoviedb.org/3/discover/movie?with_genres=27&page=${req.params.page}&include_video=false&include_adult=true&sort_by=vote_count.desc&language=en-US&api_key=ec02ef25080a229b2b0920c539157f7c`)
      .then(body => {
        body.buffer()
